...
public class Topogen {
    ...
    public static void main(String[] args) {
        ...
        long sourceSeed = args.length>=4 ? Long.parseLong(args[3]) : System.currentTimeMillis();
        long attackersSeed = args.length>=5 ? Long.parseLong(args[4]) : System.currentTimeMillis();
